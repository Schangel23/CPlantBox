...
PYBIND11_MODULE(plantbox, m) {
    ...
    py::class_<RootRandomParameter, OrganRandomParameter, std::shared_ptr<RootRandomParameter>>(m, "RootRandomParameter")
            ...
            .def_readwrite("c_cost_per_cm", &RootRandomParameter::c_cost_per_cm)
            .def_readwrite("local_C_pool_capacity_factor", &RootRandomParameter::local_C_pool_capacity_factor)
    ...
    py::class_<LeafRandomParameter, OrganRandomParameter, std::shared_ptr<LeafRandomParameter>>(m, "LeafRandomParameter")
      ...
      .def_readwrite("c_cost_per_cm", &LeafRandomParameter::c_cost_per_cm)
      .def_readwrite("local_C_pool_capacity_factor", &LeafRandomParameter::local_C_pool_capacity_factor)
    ...
    py::class_<StemRandomParameter, OrganRandomParameter, std::shared_ptr<StemRandomParameter>>(m, "StemRandomParameter")
            ...
            .def_readwrite("c_cost_per_cm", &StemRandomParameter::c_cost_per_cm)
            .def_readwrite("local_C_pool_capacity_factor", &StemRandomParameter::local_C_pool_capacity_factor)
...
//		.def_readwrite("organParam", &MappedSegments::plantParam)
   ...
   py::class_<Photosynthesis, PlantHydraulicModel, std::shared_ptr<Photosynthesis>>(m, "Photosynthesis")
            ...
            .def_readwrite("Ja", &Photosynthesis::Ja)
            ...
            .def_readwrite("vcm_alpha", &Photosynthesis::vcm_alpha)
            .def_readwrite("vcm_Vpr", &Photosynthesis::vcm_Vpr)
            .def_readwrite("vcm_kf", &Photosynthesis::vcm_kf)
            .def_readwrite("vcm_kD", &Photosynthesis::vcm_kD)
            .def_readwrite("vcm_kd", &Photosynthesis::vcm_kd)
            .def_readwrite("vcm_po0max", &Photosynthesis::vcm_po0max)
            .def_readwrite("vcm_beta", &Photosynthesis::vcm_beta)
