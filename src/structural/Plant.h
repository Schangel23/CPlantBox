...
public:
  ...
  enum TropismTypes { tt_plagio = 0, tt_gravi = 1, tt_exo = 2, tt_hydro = 3, tt_antigravi = 4, tt_twist = 5,  tt_antigravi2gravi = 6, tt_distalgravi = 7, tt_prescribed_midrib = 8, tt_curvature_profile = 9};  ///< plant tropism types
  enum GrowthFunctionTypes { gft_negexp = 1, gft_linear = 2 , gft_CWLim = 3, gft_gompertz = 4, gft_multi_phase_stem = 5, gft_multi_phase_leaf = 6 }; // plant growth function
