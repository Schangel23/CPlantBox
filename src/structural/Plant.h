...
public:
  ...
  enum TropismTypes { tt_plagio = 0, tt_gravi = 1, tt_exo = 2, tt_hydro = 3, tt_antigravi = 4, tt_twist = 5,  tt_antigravi2gravi = 6, tt_distalgravi = 7, tt_prescribed_midrib = 8};  ///< plant tropism types
