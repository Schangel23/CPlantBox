...
public:
    ...
    int internode_maturity_extends_cessation = 0;      ///< OPT-IN: keep per-rank operational cessation open until the maturity window can reach m=1. Explicit delayNGEnd/tt_cessation thresholds remain authoritative. Default 0 preserves existing trajectories.
