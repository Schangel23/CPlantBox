...
public:
    ...
    int internode_collar_onset_gate = 0;               ///< OPT-IN: hold internode n at the maturity floor until leaf-n collar is above leaf-(n-1) collar, then release to the existing maturity gate. Default 0 = disabled.
